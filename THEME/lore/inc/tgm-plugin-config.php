...
if ( ! function_exists( 'lsvr_lore_register_required_plugins' ) ) {
    function lsvr_lore_register_required_plugins() {
         ...
         */
            $plugins = array(
        		array(
        			'name'     				=> esc_html__( 'Lore Theme Toolkit', 'lore' ),
        			'slug'     				=> 'lsvr-toolkit-lore',
                    'source'                => get_template_directory() . '/inc/plugins/lsvr-toolkit-lore.zip',
        			'required' 				=> false,
        			'version' 				=> '1.0.2',
